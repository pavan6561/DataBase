...
// -----------------------------------------------------------------------------------------------------------
// File Name   : CryptoKeySlot.h
//
// Purpose     : This file contains CryptoKeyslots structure.
// ------------------------------------------------------------------------------------------------------------

#ifndef CRYPTO_SOURCE_CONFIG_INC_PUBLIC_CRYPTOKEYSLOT_H_
#define CRYPTO_SOURCE_CONFIG_INC_PUBLIC_CRYPTOKEYSLOT_H_
...
namespace config
{
/// @brief class for CryptoKeyslots.
class CryptoKeyslots final
{
 public:
  /// @brief Constructor for CryptoKeyslots class.
  CryptoKeyslots()
  {
  }

  /// @brief Destructor for CryptoKeyslots class.
  ~CryptoKeyslots()
  {
  }

  /// @brief Variable to store uuid.
...
#endif // CRYPTO_SOURCE_CONFIG_INC_PUBLIC_CRYPTOKEYSLOT_H_
