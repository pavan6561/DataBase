...
// -----------------------------------------------------------------------------------------------------------
// File Name   : ocsp_response_impl.cpp
//
// Purpose     : This file provides OcspResponseImpl class definitions.
// -----------------------------------------------------------------------------------------------------------
...
ara::core::Result<ara::core::Vector<ara::core::Byte>> OcspResponseImpl::ExportPublicly(Serializable::FormatId formatId) 
const noexcept
{
  ...
  if ((formatId == Serializable::kFormatDerEncoded) || (formatId == Serializable::kFormatDefault))
  {
    ...
    int32_t len{ i2d_OCSP_RESPONSE(responce_, &ocspPtr) };
