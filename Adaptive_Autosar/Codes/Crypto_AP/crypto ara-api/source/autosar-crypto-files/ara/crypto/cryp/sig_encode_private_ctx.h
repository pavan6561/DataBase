...
// -----------------------------------------------------------------------------------------------------------
// File Name   : sig_encode_private_ctx.h
//
// Purpose     : This file contains definitions for SigEncodePrivateCtx abstract class.
// -----------------------------------------------------------------------------------------------------------

#ifndef CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_SIG_ENCODE_PRIVATE_CTX_H_
#define CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_SIG_ENCODE_PRIVATE_CTX_H_
...
class SigEncodePrivateCtx : public CryptoContext
{
 public:
  ...
  virtual ara::core::Result<ara::core::Vector<ara::core::Byte>> SignAndEncode(ReadOnlyMemRegion in) const
    noexcept
    = 0;
...
#endif // CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_SIG_ENCODE_PRIVATE_CTX_H_
