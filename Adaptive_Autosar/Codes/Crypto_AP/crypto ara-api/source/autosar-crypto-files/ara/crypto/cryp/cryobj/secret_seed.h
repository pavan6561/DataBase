...
#ifndef CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_CRYOBJ_SECRET_SEED_H_
#define CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_CRYOBJ_SECRET_SEED_H_
...
class SecretSeed : public RestrictedUseObject
{
 public:
  ...
  /// @brief constructor for SecretSeed class.
  SecretSeed(ReadWriteMemRegion seed) noexcept : RestrictedUseObject{ seed }
  {
    aralog_.LogDebug() << "In SecretSeed constructor";
  }

  /// @brief Getter method for Seed value.
  ReadWriteMemRegion GetSeedValue() const noexcept
  {
    aralog_.LogDebug() << "In SecretSeed::GetSeedValue()";
    return GetValue();
  }

  /// @brief Setter method for Seed value.
  void SetSeedValue(ReadWriteMemRegion setSeedValue) noexcept
  {
    aralog_.LogDebug() << "In SecretSeed::SetSeedValue()";
 ...
 private:
  ...
  ara::log::Logger& aralog_{ ara::log::CreateLogger(
    "SSCO", "Secrect Seed Crypto Object", ara::log::LogLevel::kVerbose) };
};
...
#endif // CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_CRYOBJ_SECRET_SEED_H_
