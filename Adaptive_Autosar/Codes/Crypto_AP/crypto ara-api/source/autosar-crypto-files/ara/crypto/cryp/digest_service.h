...
#ifndef SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_DIGEST_SERVICE_H_
#define SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_DIGEST_SERVICE_H_
...
public:
    ...
    /// @returns @c true if the processing was start by a call of the @c Start() methods and was not finished 
    /// yet
...
#endif /* SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_DIGEST_SERVICE_H_ */
