...
#ifndef CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_KEY_DERIVATION_FUNCTION_CTX_H_
#define CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_KEY_DERIVATION_FUNCTION_CTX_H_
...
class KeyDerivationFunctionCtx : public CryptoContext
{
 public:
  ...
  /// @error SecurityErrorDomain::kUninitializedContext  if the context was not sufficiently initialized
  /// @trace SWS_CRYPT_21516_001, SWS_CRYPT_21516_002, SWS_CRYPT_00609_001, SWS_CRYPT_00611_002
...
#endif // CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_KEY_DERIVATION_FUNCTION_CTX_H_
