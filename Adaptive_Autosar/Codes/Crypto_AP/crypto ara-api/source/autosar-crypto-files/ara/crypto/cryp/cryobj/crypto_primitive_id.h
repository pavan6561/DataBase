...
#ifndef CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_CRYOBJ_CRYPTO_PRIMITIVE_ID_H_
#define CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_CRYOBJ_CRYPTO_PRIMITIVE_ID_H_
...
{
 public:
  /// @brief Constructor for CryptoPrimitiveId class.
  CryptoPrimitiveId() noexcept = default;

  /// @brief Move constructor for CryptoPrimitiveId class.
  CryptoPrimitiveId(CryptoPrimitiveId&& other) noexcept = default;
