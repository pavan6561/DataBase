...
#ifndef CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_BLOCK_CIPHER_CTX_H_
#define CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_BLOCK_CIPHER_CTX_H_
...
class SymmetricBlockCipherCtx : public CryptoContext
{
 public:
  ...
  /// @error SecurityErrorDomain::kUninitializedContext  if the transformation direction of this context
  /// is configurable during an initialization, but the context was not initialized yet
  /// @trace SWS_CRYPT_23712_001, SWS_CRYPT_23712_002
  ara::core::Result<bool> IsMaxInputOnly() const noexcept
  {
    ara::core::Result<CryptoTransform> result{ GetTransformation() };
    if (!result)
    {
  ...
  /// @error SecurityErrorDomain::kUninitializedContext  if the transformation direction of this context
  /// is configurable during an initialization, but the context was not initialized yet
  /// @trace SWS_CRYPT_23713_001, SWS_CRYPT_23713_002
...
#endif // CRYPTO_SOURCE_AUTOSAR_CRYPTO_FILES_ARA_CRYPTO_CRYP_BLOCK_CIPHER_CTX_H_
