...
// -----------------------------------------------------------------------------------------------------------
// File Name   : secret_seed_impl.h
//
// Purpose     : This file contains definitions for SecretSeedImpl class.
// -----------------------------------------------------------------------------------------------------------

#ifndef CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_CRYOBJ_SECRET_SEED_IMPL_H_
#define CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_CRYOBJ_SECRET_SEED_IMPL_H_
...
class SecretSeedImpl : public SecretSeed
{
 public:
  /// @brief constructor for SecretSeedImpl class.
  /// @param[in] Seed value in the form of ReadWriteMemRegion.
  /// @param[in] usageFlagsVal allowed usage flags for this secret seed object.
  /// @param[in] algorithm name supported by this secret seed object.
  /// @param[in] algorithm Id supported by this secret seed object.
  ...
  SecretSeedImpl(ReadWriteMemRegion seed, Usage usageFlagsVal, ara::core::String primitiveName,
  ...
  {
    aralog_.LogDebug() << "In SecretSeedImpl::GetAllowedUsage()";
    return usageFlags;
  }
  ...
  {
    aralog_.LogDebug() << "In SecretSeedImpl::IsSession()";
  ...
  {
    aralog_.LogDebug() << "In SecretSeedImpl::IsExportable()";
  ...
  {
    aralog_.LogDebug() << "In SecretSeedImpl::GetObjectId()";
    return objectID;
  }
  ...
  {
    aralog_.LogDebug() << "In SecretSeedImpl::HasDependence()";
  ...
  /// If the associated cryptographic algorithm doesn't specify a "counting" expression then generic
  /// increment operation must be implemented as default (little-endian notation, i.e.
 ...
 private:
  ...
  /// @brief exportable flag to set the scope of this crypto object
  ...
  ara::log::Logger& aralog_{ ara::log::CreateLogger(
    "SSIO", "Secrect Seed Impl Object", ara::log::LogLevel::kVerbose) };
};
...
#endif // CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_CRYOBJ_SECRET_SEED_IMPL_H_
