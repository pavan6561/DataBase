...
//
// Purpose     : This file contains definitions for PrivateKeyImpl class.
// -----------------------------------------------------------------------------------------------------------

#ifndef CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_CRYOBJ_PRIVATE_KEY_IMPL_H_
#define CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_CRYOBJ_PRIVATE_KEY_IMPL_H_
...
{
 public:
  /// @brief Contructor for PrivateKeyImpl class.
  PrivateKeyImpl(ReadWriteMemRegion key, Usage usageFlagsVal, ara::core::String primitiveName,
    CryptoPrimitiveId::AlgId primitiId, bool sessionValue, bool exportableValue,
    CryptoObjectUid uuid) noexcept;

  /// @brief Destructor for PrivateKeyImpl class.
  ~PrivateKeyImpl() noexcept = default;
  ...
  {
    aralog_.LogDebug() << "In PrivateKeyImpl::GetAllowedUsage()";
    return usageFlags;
  }
  ...
  {
    aralog_.LogDebug() << "In PrivateKeyImpl::IsSession()";
  ...
  {
    aralog_.LogDebug() << "In PrivateKeyImpl::IsExportable()";
  ...
  {
    aralog_.LogDebug() << "In PrivateKeyImpl::GetObjectId()";
    return objectID;
  }
  ...
  {
    aralog_.LogDebug() << "In PrivateKeyImpl::HasDependence()";
  ...
  /// @brief Getter method to get openssl private key pointer.
 ...
 private:
  ...
  /// @brief variable to hold the smart unique pointer to CryptoPrimitiveId class.
  CryptoPrimitiveId::Uptr crypObjectPrimitiveId_;
  ...
  EVP_PKEY* rsaPrivateKeyPtr_;

  /// @brief logger variable for ara::log.
  ara::log::Logger& aralog_{ ara::log::CreateLogger(
    "PRCO", "Private Key Impl Crypto Object", ara::log::LogLevel::kVerbose) };
};
...
#endif // CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_CRYOBJ_PRIVATE_KEY_IMPL_H_
