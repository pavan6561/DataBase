...
// -----------------------------------------------------------------------------------------------------------
// File Name   : signature_service_impl.h
//
// Purpose     : This file contains the definition required for signatureservice application.
// -----------------------------------------------------------------------------------------------------------

#ifndef CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_SIGNATURE_SERVICE_IMPL_H_
#define CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_SIGNATURE_SERVICE_IMPL_H_
...
namespace cryp
{
/// @brief Implementation of Signature service
class SignatureServiceImpl: public SignatureService
{
public:

  /// @brief Constructor for SignatureServiceImpl class. 
  SignatureServiceImpl(CryptoAlgId algoid, size_t currentKeyBitSize, AllowedUsageFlags 
    currentUsageFlags, CryptoObjectUid id, bool isKeyAvailableinCrrentCtx) noexcept;

  /// @brief Destructor for SignatureServiceImpl class.
  ~SignatureServiceImpl() noexcept;
  ...
  CryptoPrimitiveId::AlgId GetRequiredHashAlgId() const noexcept ;
...
#endif // CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_SIGNATURE_SERVICE_IMPL_H_
