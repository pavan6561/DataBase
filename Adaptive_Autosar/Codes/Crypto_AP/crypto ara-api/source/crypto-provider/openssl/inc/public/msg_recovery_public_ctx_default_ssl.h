...
// -----------------------------------------------------------------------------------------------------------
// File Name   : msg_recovery_public_ctx_default_ssl.h
//
// Purpose   : This file contains definitions for MsgRecoveryPublicCtxDefaultssl class.
// -----------------------------------------------------------------------------------------------------------

#ifndef CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_MSG_RECOVERY_PUBLIC_CTX_DEFAULT_SSL_H_
#define CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_MSG_RECOVERY_PUBLIC_CTX_DEFAULT_SSL_H_
...
class MsgRecoveryPublicCtxDefaultssl : public MsgRecoveryPublicCtx
{
 public:
  /// @brief Constructor of MsgRecoveryPublicCtxDefaultssl class.
  MsgRecoveryPublicCtxDefaultssl(AlgId algo) noexcept : algId_{ algo }
  {
  }
 ...
 private:
  ...
  void ConfigureVerifyCtx(EVP_PKEY_CTX* keyCtx) const noexcept;
  ...
  ara::log::Logger& aralog_{ ara::log::CreateLogger(
    "MRPC", "Message Recovery Private context", ara::log::LogLevel::kVerbose) };
};
...
#endif // CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_MSG_RECOVERY_PUBLIC_CTX_DEFAULT_SSL_H_
