...
// -----------------------------------------------------------------------------------------------------------
// File Name   : sig_encode_private_ctx_default_ssl.h
//
// Purpose   : This file contains definitions for SigEncodePrivateCtxDefaultSsl class.
// -----------------------------------------------------------------------------------------------------------

#ifndef CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_SIG_ENCODE_PRIVATE_CTX_DEFAULT_SSL_H_
#define CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_SIG_ENCODE_PRIVATE_CTX_DEFAULT_SSL_H_
...
/// @trace SWS_CRYPT_23200
class SigEncodePrivateCtxDefaultSsl : public SigEncodePrivateCtx
{
 public:
  /// @brief Constructor for SigEncodePrivateCtxDefaultSsl class.
  SigEncodePrivateCtxDefaultSsl(AlgId algo) noexcept : algId_{ algo }
  {
  }
 ...
 private:
  /// @brief Configure the verify ctx of the Openssl.
  ...
  ara::log::Logger& aralog_{ ara::log::CreateLogger(
    "SEPC", "Signer Encode Private context", ara::log::LogLevel::kVerbose) };
};
...
#endif // CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_SIG_ENCODE_PRIVATE_CTX_DEFAULT_SSL_H_
