...
// -----------------------------------------------------------------------------------------------------------
// File Name   : symmetric_key_impl.h
//
// Purpose     : This file contains definitions for SymmetricKeyImpl class.
// -----------------------------------------------------------------------------------------------------------

#ifndef CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_CRYOBJ_SYMMETRIC_KEY_IMPL_H_
#define CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_CRYOBJ_SYMMETRIC_KEY_IMPL_H_
...
class SymmetricKeyImpl : public SymmetricKey
{
 public:
  /// @brief constructor for SymmetricKeyImpl class.
  /// @param[in] key value in the form of ReadWriteMemRegion.
  /// @param[in] usageFlagsVal allowed usage flags for this SymmetricKey object.
  /// @param[in] algorithm name supported by this SymmetricKey object.
  /// @param[in] algorithm Id supported by this SymmetricKey object.
  ...
  SymmetricKeyImpl(ReadWriteMemRegion key, Usage usageFlagsVal, ara::core::String primitiveName,
  ...
  {
    aralog_.LogDebug() << "In SymmetricKeyImpl::GetAllowedUsage()";
    return usageFlags;
  }
  ...
  {
    aralog_.LogDebug() << "In SymmetricKeyImpl::IsSession()";
  ...
  {
    aralog_.LogDebug() << "In SymmetricKeyImpl::IsExportable()";
  ...
  {
    aralog_.LogDebug() << "In SymmetricKeyImpl::GetObjectId()";
    return objectID;
  }
  ...
  {
    aralog_.LogDebug() << "In SymmetricKeyImpl::HasDependence()";
 ...
 private:
  ...
  ara::log::Logger& aralog_{ ara::log::CreateLogger(
    "SICO", "Symmetric Key Impl Crypto Object", ara::log::LogLevel::kVerbose) };
};
...
#endif // CRYPTO_SOURCE_CRYPTO_PROVIDER_OPENSSL_INC_PUBLIC_CRYOBJ_SYMMETRIC_KEY_IMPL_H_
