...
// -----------------------------------------------------------------------------------------------------------
// File Name   : key_storage_provider.h
//
// Purpose     : This file contains KeyStorageProvider interface definition.
// -----------------------------------------------------------------------------------------------------------

#ifndef CRYPTO_SOURCE_ARA_CRYPTO_AUTOSAR_ARA_CRYPTO_KEYS_KEY_STORAGE_PROVIDER_H_
#define CRYPTO_SOURCE_ARA_CRYPTO_AUTOSAR_ARA_CRYPTO_KEYS_KEY_STORAGE_PROVIDER_H_
...
{
 public:
  /// @brief unique pointer for KeyStorageProvider.
  /// @trace SWS_CRYPT_30101
  using Uptr = std::unique_ptr<KeyStorageProvider>;

  /// @brief Destructor.
  /// @trace SWS_CRYPT_30110
  ...
  virtual ara::core::Result<KeySlot::Uptr> LoadKeySlot(ara::core::String& iSpecify) noexcept = 0;
  ...
  //  virtual ara::core::Result<TransactionId> BeginTransaction(const TransactionScope& targetSlots)
  //  noexcept = 0;
  ...
  /// The method returns @c nullptr if no observers have been registered yet!
  /// @returns unique pointer to the registered Updates Observer interface (copy of an internal unique
  /// pointer is returned, i.e. the %Key Storage provider continues to keep the ownership)
...
#endif // CRYPTO_SOURCE_ARA_CRYPTO_AUTOSAR_ARA_CRYPTO_KEYS_KEY_STORAGE_PROVIDER_H_
