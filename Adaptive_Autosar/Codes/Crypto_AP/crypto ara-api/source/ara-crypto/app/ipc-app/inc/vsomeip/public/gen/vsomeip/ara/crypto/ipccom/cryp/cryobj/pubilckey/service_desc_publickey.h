...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_publickey.h
//
// Purpose     : Implementation of file service_desc_publickey.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_PUBILCKEY_SERVICE_DESC_PUBLICKEY_H_
#define CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_PUBILCKEY_SERVICE_DESC_PUBLICKEY_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x2654};
...
/// @brief class for CheckKey.
class CheckKey : public internal::Service {
 public:
...
/// @brief class for HashPublicKey.
class HashPublicKey : public internal::Service {
 public:
...
#endif // CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_PUBILCKEY_SERVICE_DESC_PUBLICKEY_H_
