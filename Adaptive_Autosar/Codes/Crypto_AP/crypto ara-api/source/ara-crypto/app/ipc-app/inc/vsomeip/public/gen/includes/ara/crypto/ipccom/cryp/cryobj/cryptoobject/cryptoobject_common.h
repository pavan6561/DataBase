...
// -----------------------------------------------------------------------------------------------------------
// File Name   : cryptoobject_common.h
//
// Purpose     : Implementation of file cryptoobject_common.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_CRYPTOOBJECT_CRYPTOOBJECT_COMMON_H_
#define CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_CRYPTOOBJECT_CRYPTOOBJECT_COMMON_H_
...
/// @brief Class for CryptoObject.
class  CryptoObject {
 public:
  /// @brief Definition for CryptoObject.
  virtual ~CryptoObject() noexcept
  {}
  static constexpr ara::com::internal::ServiceId service_id{0xB51D};
...
#endif // CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_CRYPTOOBJECT_CRYPTOOBJECT_COMMON_H_
