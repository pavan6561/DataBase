...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_privatekey.h
//
// Purpose     : Implementation of file service_desc_privatekey.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_PRIVATEKEY_SERVICE_DESC_PRIVATEKEY_H_
#define CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_PRIVATEKEY_SERVICE_DESC_PRIVATEKEY_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x2655};
...
/// @brief class for GetPublicKey.
class GetPublicKey : public internal::Service {
 public:
...
#endif // CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_PRIVATEKEY_SERVICE_DESC_PRIVATEKEY_H_
