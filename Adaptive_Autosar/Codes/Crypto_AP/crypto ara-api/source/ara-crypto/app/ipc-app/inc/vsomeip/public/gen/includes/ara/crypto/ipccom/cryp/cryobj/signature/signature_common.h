...
// -----------------------------------------------------------------------------------------------------------
// File Name   : signature_common.h
//
// Purpose     : Implementation of file signature_common.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SIGNATURE_SIGNATURE_COMMON_H_
#define CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SIGNATURE_SIGNATURE_COMMON_H_
...
/// @brief Class for Signature.
class  Signature {
 public:
  /// @brief Definition for Signature.
  virtual ~Signature() noexcept
  {}
  static constexpr ara::com::internal::ServiceId service_id{0x0D76};
  ...
  {
    public:
    /// @brief Argument for ByteVector.
    ByteVectorType ByteVector;
  ...
  /// @brief class for GetHashAlgIdOutput.
  class GetHashAlgIdOutput
  {
    public:
    /// @brief Argument for CryptoPrimitiveIdAlgId.
    CryptoAlgId CryptoPrimitiveIdAlgId;
    /// @brief Using for success.
    using IsEnumerableTag = void;
    template<typename F>
    /// @brief Using for enumerate.
    void enumerate(F& fun) noexcept(false) {
      fun(CryptoPrimitiveIdAlgId);
    }
  };
...
#endif // CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SIGNATURE_SIGNATURE_COMMON_H_
