...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_cryptoservice.h
//
// Purpose     : Implementation of file service_desc_cryptoservice.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_CRYPTOSERVICE_SERVICE_DESC_CRYPTOSERVICE_H_
#define CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_CRYPTOSERVICE_SERVICE_DESC_CRYPTOSERVICE_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x268D};
...
/// @brief class for GetMaxInputSize.
class GetMaxInputSize : public internal::Service {
 public:
...
/// @brief class for GetMaxOutputSize.
class GetMaxOutputSize : public internal::Service {
 public:
...
#endif // CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_CRYPTOSERVICE_SERVICE_DESC_CRYPTOSERVICE_H_
