...
// -----------------------------------------------------------------------------------------------------------
// File Name   : msgrecoverypubliccontext_common.h
//
// Purpose     : Implementation of file msgrecoverypubliccontext_common.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_MSGRECOVERYPUBLICCONTEXT_MSGRECOVERYPUBLICCONTEXT_COMMON_H_
#define CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_MSGRECOVERYPUBLICCONTEXT_MSGRECOVERYPUBLICCONTEXT_COMMON_H_
...
/// @brief Class for MsgRecoveryPublicContext.
class  MsgRecoveryPublicContext {
 public:
  /// @brief Definition for MsgRecoveryPublicContext.
  virtual ~MsgRecoveryPublicContext() noexcept
  {}
  static constexpr ara::com::internal::ServiceId service_id{0x553B};
  ...
  static constexpr ara::core::Array<ara::core::ErrorCode, 2>DecodeAndVerify_PossibleErrors {
    {
  ...
  /// @brief class for DecodeAndVerifyOutput.
  class DecodeAndVerifyOutput
  {
    public:
  ...
  /// @brief class for GetMaxInputSizeOutput.
  class GetMaxInputSizeOutput
  {
    public:
    /// @brief Argument for inputSize.
    uint64 inputSize;
    /// @brief Using for success.
    using IsEnumerableTag = void;
    template<typename F>
  ...
  /// @brief class for GetMaxOutputSizeOutput.
  class GetMaxOutputSizeOutput
  {
    public:
    /// @brief Argument for outputSize.
    uint64 outputSize;
    /// @brief Using for success.
    using IsEnumerableTag = void;
    template<typename F>
...
#endif // CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_MSGRECOVERYPUBLICCONTEXT_MSGRECOVERYPUBLICCONTEXT_COMMON_H_
