...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_signerprivatecontext.h
//
// Purpose     : Implementation of file service_desc_signerprivatecontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SIGNERPRIVATECONTEXT_SERVICE_DESC_SIGNERPRIVATECONTEXT_H_
#define CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SIGNERPRIVATECONTEXT_SERVICE_DESC_SIGNERPRIVATECONTEXT_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x266E};
...
/// @brief class for SignPreHashedHashFunction.
class SignPreHashedHashFunction : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x1};
  static constexpr bool is_reliable{false};
};
/// @brief class for SignPreHashedReadOnly.
class SignPreHashedReadOnly : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x3};
  static constexpr bool is_reliable{false};
};
/// @brief class for SignReadOnly.
class SignReadOnly : public internal::Service {
 public:
...
#endif // CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SIGNERPRIVATECONTEXT_SERVICE_DESC_SIGNERPRIVATECONTEXT_H_
