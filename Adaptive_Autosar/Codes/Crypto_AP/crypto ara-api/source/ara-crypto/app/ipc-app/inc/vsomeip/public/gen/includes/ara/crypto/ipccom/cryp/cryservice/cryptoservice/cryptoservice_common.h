...
// -----------------------------------------------------------------------------------------------------------
// File Name   : cryptoservice_common.h
//
// Purpose     : Implementation of file cryptoservice_common.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_CRYPTOSERVICE_CRYPTOSERVICE_COMMON_H_
#define CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_CRYPTOSERVICE_CRYPTOSERVICE_COMMON_H_
...
/// @brief Class for CryptoService.
class  CryptoService {
 public:
  /// @brief Definition for CryptoService.
  virtual ~CryptoService() noexcept
  {}
  static constexpr ara::com::internal::ServiceId service_id{0xF3D5};
...
#endif // CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_CRYPTOSERVICE_CRYPTOSERVICE_COMMON_H_
