...
// -----------------------------------------------------------------------------------------------------------
// File Name   : hashfunction_common.h
//
// Purpose     : Implementation of file hashfunction_common.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_HASHFUNCTION_HASHFUNCTION_COMMON_H_
#define CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_HASHFUNCTION_HASHFUNCTION_COMMON_H_
...
/// @brief Class for HashFunction.
class  HashFunction {
 public:
  /// @brief Definition for HashFunction.
  virtual ~HashFunction() noexcept
  {}
  static constexpr ara::com::internal::ServiceId service_id{0x5605};
  ...
  {
    public:
    /// @brief Argument for finishResult.
    ByteVectorType finishResult;
  ...
  static constexpr ara::core::Array<ara::core::ErrorCode, 1>GetDigest_PossibleErrors {
    {
  ...
  static constexpr ara::core::Array<ara::core::ErrorCode, 1>StartNoParam_PossibleErrors {
    {
    ::ara::crypto::ipccom::common::error::MakeErrorCode(ara::crypto::ipccom::common::error::CryptoErrorDomainErrc::kMissingArgument, 0),
    }
  };
  static constexpr ara::core::Array<ara::core::ErrorCode, 2>StartReadOnlyMem_PossibleErrors {
    {
  ...
  static constexpr ara::core::Array<ara::core::ErrorCode, 2>StartSecretSeed_PossibleErrors {
    {
    ::ara::crypto::ipccom::common::error::MakeErrorCode(ara::crypto::ipccom::common::error::CryptoErrorDomainErrc::kInvalidInputSize, 0),
    ::ara::crypto::ipccom::common::error::MakeErrorCode(ara::crypto::ipccom::common::error::CryptoErrorDomainErrc::kUnsupported, 0),
    }
...
#endif // CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_HASHFUNCTION_HASHFUNCTION_COMMON_H_
