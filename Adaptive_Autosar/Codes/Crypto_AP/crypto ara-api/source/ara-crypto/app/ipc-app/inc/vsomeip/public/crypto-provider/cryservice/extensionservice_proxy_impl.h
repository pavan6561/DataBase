...
// -----------------------------------------------------------------------------------------------------------
// File Name : extensionservice_proxy_impl.h
//
// Purpose : Crypto object proxy implementation to forward functional calls from application to ipc-core.
// -----------------------------------------------------------------------------------------------------------

#ifndef CRYPTO_SOURCE_ARA_CRYPTO_APP_IPC_APP_INC_VSOMEIP_PUBLIC_CRYPTO_PROVIDER_CRYSERVICE_EXTENSIONSERVICE_PROXY_IMPL_H_
#define CRYPTO_SOURCE_ARA_CRYPTO_APP_IPC_APP_INC_VSOMEIP_PUBLIC_CRYPTO_PROVIDER_CRYSERVICE_EXTENSIONSERVICE_PROXY_IMPL_H_

#include <ara/log/logging.h>

#include "ara/crypto/cryp/extension_service.h"
#include "crypto_primitive_id_proxy_impl.h"
#include "extensionservice_proxy.h"
...
class ExtensionServiceProxyImpl : public ara::crypto::cryp::ExtensionService
{
 public:
  /// @brief Constructor of ExtensionServiceProxyImpl class.
  /// @param[in] serviceInstanceID of Crypto service instance id.
  ExtensionServiceProxyImpl(const CryptoServiceInstanceId serviceInstanceID) noexcept;

  /// @brief Destructor used to destruct the object of ExtensionServiceProxyImpl.
  virtual ~ExtensionServiceProxyImpl() noexcept = default;
 ...
 private:
  ...
  ara::crypto::vsomeip::VsomeipInterface<
      ara::crypto::ipccom::cryp::cryservice::extensionservice::proxy::ExtensionServiceProxy>
      vsomeipInstance_;

  /// @brief Crypto Object context proxy handler.
  std::shared_ptr<ara::crypto::ipccom::cryp::cryservice::extensionservice::proxy::ExtensionServiceProxy>
      extensionServiceHandler_;
...
#endif // CRYPTO_SOURCE_ARA_CRYPTO_APP_IPC_APP_INC_VSOMEIP_PUBLIC_CRYPTO_PROVIDER_CRYSERVICE_EXTENSIONSERVICE_PROXY_IMPL_H_
