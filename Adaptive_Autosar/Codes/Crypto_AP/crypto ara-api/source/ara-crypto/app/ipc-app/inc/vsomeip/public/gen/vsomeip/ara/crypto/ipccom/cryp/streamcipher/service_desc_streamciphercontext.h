...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_streamciphercontext.h
//
// Purpose     : Implementation of file service_desc_streamciphercontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_STREAMCIPHER_SERVICE_DESC_STREAMCIPHERCONTEXT_H_
#define CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_STREAMCIPHER_SERVICE_DESC_STREAMCIPHERCONTEXT_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x264F};
...
/// @brief class for CountBytesInCache.
class CountBytesInCache : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x7};
  static constexpr bool is_reliable{false};
};
/// @brief class for FinishBytes.
class FinishBytes : public internal::Service {
 public:
...
/// @brief class for IsBytewiseMode.
class IsBytewiseMode : public internal::Service {
 public:
...
/// @brief class for IsSeekableMode.
class IsSeekableMode : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x2};
  static constexpr bool is_reliable{false};
};
/// @brief class for ProcessBlocks.
class ProcessBlocks : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x4};
  static constexpr bool is_reliable{false};
};
/// @brief class for ProcessByte.
class ProcessByte : public internal::Service {
 public:
...
/// @brief class for Seek.
class Seek : public internal::Service {
 public:
...
#endif // CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_STREAMCIPHER_SERVICE_DESC_STREAMCIPHERCONTEXT_H_
