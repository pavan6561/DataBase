...
// -----------------------------------------------------------------------------------------------------------
// File Name   : sig_encode_private_ctx_proxy_impl.h
//
...
#ifndef CRYPTO_SOURCE_ARA_CRYPTO_APP_IPC_APP_INC_VSOMEIP_PUBLIC_CRYPTO_PROVIDER_SIG_ENCODE_PRIVATE_CTX_PROXY_IMPL_H_
#define CRYPTO_SOURCE_ARA_CRYPTO_APP_IPC_APP_INC_VSOMEIP_PUBLIC_CRYPTO_PROVIDER_SIG_ENCODE_PRIVATE_CTX_PROXY_IMPL_H_
...
#include "sigencodeprivatecontext_proxy.h"
...
namespace cryp
{
class SigEncodePrivateCtxProxyImpl final : public ara::crypto::cryp::SigEncodePrivateCtx
{
 public:
  /// @brief Constructor for the SigEncodePrivateCtxProxyImpl class.
  ...
  SigEncodePrivateCtxProxyImpl(CryptoServiceInstanceId const instanceValue,
  ...
  /// @brief Destructor for the SigEncodePrivateCtxProxyImpl class.
  ~SigEncodePrivateCtxProxyImpl() noexcept
  {
    sigEncCryptoProviderHandler_->StopCryptoProviderService(
      CryptoProviderServiceType::kSigEncodePrivateCtx, vsomeipSeprInstance_.serviceInstanceID_);
  }
  ...
  /// @trace SWS_CRYPT_23215
  ara::core::Result<ara::core::Vector<ara::core::Byte>> SignAndEncode(ReadOnlyMemRegion in) const
    noexcept override;
  ...
  /// @trace SWS_CRYPT_23210
  ExtensionService::Uptr GetExtensionService() const noexcept override;

 private:
  /// @brief Method to initializing the server-client connection for SigEncode Private context.
  /// @param[in] serviceInstanceID Crypto service instance id.
  bool Initialize(CryptoServiceInstanceId const serviceInstanceID);

  /// @brief vsome-ip instance for SigEncode Private Context proxy.
  ara::crypto::vsomeip::VsomeipInterface<
    ara::crypto::ipccom::cryp::signencodeprivatecontext::proxy::SigEncodePrivateContextProxy>
    vsomeipSeprInstance_;

  /// @brief crypto provider handler
  std::shared_ptr<ara::crypto::ipccom::cryp::cryptoprovider::proxy::CryptoProviderInterfaceProxy>
    sigEncCryptoProviderHandler_;

  /// @brief SigEncode Private Context proxy handler
  std::shared_ptr<ara::crypto::ipccom::cryp::signencodeprivatecontext::proxy::SigEncodePrivateContextProxy>
    sigEncProxyHandler_;
...
#endif // CRYPTO_SOURCE_ARA_CRYPTO_APP_IPC_APP_INC_VSOMEIP_PUBLIC_CRYPTO_PROVIDER_SIG_ENCODE_PRIVATE_CTX_PROXY_IMPL_H_
