...
// -----------------------------------------------------------------------------------------------------------
// File Name   : publickey_common.h
//
// Purpose     : Implementation of file publickey_common.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_PUBILCKEY_PUBLICKEY_COMMON_H_
#define CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_PUBILCKEY_PUBLICKEY_COMMON_H_
...
#include "impl_type_cryptoformatid.h"
...
/// @brief Class for PublicKey.
class  PublicKey {
 public:
  /// @brief Definition for PublicKey.
  virtual ~PublicKey() noexcept
  {}
  static constexpr ara::com::internal::ServiceId service_id{0xBBE4};
  ...
  /// @brief class for CheckKeyOutput.
  class CheckKeyOutput
  {
    public:
  ...
  {
    public:
    /// @brief Argument for VectorByte.
    ByteVectorType VectorByte;
    /// @brief Using for success.
    using IsEnumerableTag = void;
    template<typename F>
    /// @brief Using for enumerate.
  ...
  static constexpr ara::core::Array<ara::core::ErrorCode, 2>HashPublicKey_PossibleErrors {
    {
  ...
  /// @brief class for HashPublicKeyOutput.
  class HashPublicKeyOutput
  {
    public:
    /// @brief Argument for VectorByte.
    ByteVectorType VectorByte;
...
#endif // CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_PUBILCKEY_PUBLICKEY_COMMON_H_
