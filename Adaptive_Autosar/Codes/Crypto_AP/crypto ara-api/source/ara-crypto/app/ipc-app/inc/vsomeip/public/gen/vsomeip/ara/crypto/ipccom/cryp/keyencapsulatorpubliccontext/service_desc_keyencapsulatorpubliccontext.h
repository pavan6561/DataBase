...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_keyencapsulatorpubliccontext.h
//
// Purpose     : Implementation of file service_desc_keyencapsulatorpubliccontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_KEYENCAPSULATORPUBLICCONTEXT_SERVICE_DESC_KEYENCAPSULATORPUBLICCONTEXT_H_
#define CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_KEYENCAPSULATORPUBLICCONTEXT_SERVICE_DESC_KEYENCAPSULATORPUBLICCONTEXT_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x266D};
...
/// @brief class for AddKeyingData.
class AddKeyingData : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x1};
  static constexpr bool is_reliable{false};
};
/// @brief class for Encapsulate.
class Encapsulate : public internal::Service {
 public:
...
/// @brief class for GetEncapsulatedSize.
class GetEncapsulatedSize : public internal::Service {
 public:
...
class GetExtensionService : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{ara::com::internal::vsomeip::types::UndefinedMethodId};
  static constexpr bool is_reliable{false};
};
/// @brief class for GetKekEntropy.
class GetKekEntropy : public internal::Service {
 public:
...
#endif // CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_KEYENCAPSULATORPUBLICCONTEXT_SERVICE_DESC_KEYENCAPSULATORPUBLICCONTEXT_H_
