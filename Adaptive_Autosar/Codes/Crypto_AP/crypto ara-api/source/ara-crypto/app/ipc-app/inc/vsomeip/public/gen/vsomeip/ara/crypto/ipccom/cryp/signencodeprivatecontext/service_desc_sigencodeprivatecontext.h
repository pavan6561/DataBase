...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_sigencodeprivatecontext.h
//
// Purpose     : Implementation of file service_desc_sigencodeprivatecontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SIGNENCODEPRIVATECONTEXT_SERVICE_DESC_SIGENCODEPRIVATECONTEXT_H_
#define CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SIGNENCODEPRIVATECONTEXT_SERVICE_DESC_SIGENCODEPRIVATECONTEXT_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x2667};
...
/// @brief class for SignAndEncode.
class SignAndEncode : public internal::Service {
 public:
...
#endif // CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SIGNENCODEPRIVATECONTEXT_SERVICE_DESC_SIGENCODEPRIVATECONTEXT_H_
