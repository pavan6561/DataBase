...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_restricteduseobject.h
//
// Purpose     : Implementation of file service_desc_restricteduseobject.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_RESTRICTEDUSEOBJECT_SERVICE_DESC_RESTRICTEDUSEOBJECT_H_
#define CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_RESTRICTEDUSEOBJECT_SERVICE_DESC_RESTRICTEDUSEOBJECT_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x265C};
...
#endif // CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_RESTRICTEDUSEOBJECT_SERVICE_DESC_RESTRICTEDUSEOBJECT_H_
