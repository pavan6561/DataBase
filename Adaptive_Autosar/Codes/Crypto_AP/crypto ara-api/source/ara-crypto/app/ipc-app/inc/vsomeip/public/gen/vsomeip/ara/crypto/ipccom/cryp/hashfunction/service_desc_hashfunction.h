...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_hashfunction.h
//
// Purpose     : Implementation of file service_desc_hashfunction.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_HASHFUNCTION_SERVICE_DESC_HASHFUNCTION_H_
#define CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_HASHFUNCTION_SERVICE_DESC_HASHFUNCTION_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x264B};
...
/// @brief class for StartNoParam.
class StartNoParam : public internal::Service {
 public:
...
#endif // CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_HASHFUNCTION_SERVICE_DESC_HASHFUNCTION_H_
