...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_encryptorpubliccontext.h
//
// Purpose     : Implementation of file service_desc_encryptorpubliccontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_ENCRYPTORPUBLICCONTEXT_SERVICE_DESC_ENCRYPTORPUBLICCONTEXT_H_
#define CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_ENCRYPTORPUBLICCONTEXT_SERVICE_DESC_ENCRYPTORPUBLICCONTEXT_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x266A};
...
/// @brief class for ProcessBlockReadOnly.
class ProcessBlockReadOnly : public internal::Service {
 public:
...
#endif // CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_ENCRYPTORPUBLICCONTEXT_SERVICE_DESC_ENCRYPTORPUBLICCONTEXT_H_
