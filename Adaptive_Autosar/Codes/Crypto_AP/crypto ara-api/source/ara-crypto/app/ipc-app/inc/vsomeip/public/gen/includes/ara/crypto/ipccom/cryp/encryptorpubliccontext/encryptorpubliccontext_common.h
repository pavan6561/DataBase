...
// -----------------------------------------------------------------------------------------------------------
// File Name   : encryptorpubliccontext_common.h
//
// Purpose     : Implementation of file encryptorpubliccontext_common.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_ENCRYPTORPUBLICCONTEXT_ENCRYPTORPUBLICCONTEXT_COMMON_H_
#define CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_ENCRYPTORPUBLICCONTEXT_ENCRYPTORPUBLICCONTEXT_COMMON_H_
...
/// @brief Class for EncryptorPublicContext.
class  EncryptorPublicContext {
 public:
  /// @brief Definition for EncryptorPublicContext.
  virtual ~EncryptorPublicContext() noexcept
  {}
  static constexpr ara::com::internal::ServiceId service_id{0xEA4C};
  ...
  static constexpr ara::core::Array<ara::core::ErrorCode, 2>ProcessBlockReadOnly_PossibleErrors {
    {
  ...
  /// @brief class for ProcessBlockReadOnlyOutput.
  class ProcessBlockReadOnlyOutput
  {
    public:
...
#endif // CRYPTOCLIENTEXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_ENCRYPTORPUBLICCONTEXT_ENCRYPTORPUBLICCONTEXT_COMMON_H_
