...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_authciphercontext.h
//
// Purpose     : Implementation of file service_desc_authciphercontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_AUTHENTICATIONCIPHER_SERVICE_DESC_AUTHCIPHERCONTEXT_H_
#define CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_AUTHENTICATIONCIPHER_SERVICE_DESC_AUTHCIPHERCONTEXT_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x264E};
...
/// @brief class for GetBlockService.
class GetBlockService : public internal::Service {
 public:
...
/// @brief class for GetMaxAssociatedDataSize.
class GetMaxAssociatedDataSize : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x1};
  static constexpr bool is_reliable{false};
};
/// @brief class for GetTransformation.
class GetTransformation : public internal::Service {
 public:
...
/// @brief class for ProcessConfidentialDataReadOnlyMem.
class ProcessConfidentialDataReadOnlyMem : public internal::Service {
 public:
...
/// @brief class for UpdateAssociatedData.
class UpdateAssociatedData : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x8};
  static constexpr bool is_reliable{false};
};
/// @brief class for UpdateAssociatedDataReadOnlyMem.
class UpdateAssociatedDataReadOnlyMem : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x7};
  static constexpr bool is_reliable{false};
};
/// @brief class for UpdateAssociatedDataResUseObj.
class UpdateAssociatedDataResUseObj : public internal::Service {
 public:
...
#endif // CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_AUTHENTICATIONCIPHER_SERVICE_DESC_AUTHCIPHERCONTEXT_H_
