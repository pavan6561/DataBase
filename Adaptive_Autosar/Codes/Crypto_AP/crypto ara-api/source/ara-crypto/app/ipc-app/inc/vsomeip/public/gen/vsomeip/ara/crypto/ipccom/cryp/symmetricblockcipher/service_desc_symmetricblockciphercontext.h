...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_symmetricblockciphercontext.h
//
// Purpose     : Implementation of file service_desc_symmetricblockciphercontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SYMMETRICBLOCKCIPHER_SERVICE_DESC_SYMMETRICBLOCKCIPHERCONTEXT_H_
#define CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SYMMETRICBLOCKCIPHER_SERVICE_DESC_SYMMETRICBLOCKCIPHERCONTEXT_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x2650};
...
/// @brief class for GetCryptoService.
class GetCryptoService : public internal::Service {
 public:
...
/// @brief class for ProcessBlock.
class ProcessBlock : public internal::Service {
 public:
...
#endif // CRYPTOCLIENTEXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SYMMETRICBLOCKCIPHER_SERVICE_DESC_SYMMETRICBLOCKCIPHERCONTEXT_H_
