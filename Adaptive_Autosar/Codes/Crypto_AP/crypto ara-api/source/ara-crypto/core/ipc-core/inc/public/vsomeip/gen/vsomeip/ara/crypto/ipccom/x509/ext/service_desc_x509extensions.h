...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_x509extensions.h
//
// Purpose     : Implementation of file service_desc_x509extensions.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_EXT_SERVICE_DESC_X509EXTENSIONS_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_EXT_SERVICE_DESC_X509EXTENSIONS_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x26B4};
...
/// @brief class for Count.
class Count : public internal::Service {
 public:
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_EXT_SERVICE_DESC_X509EXTENSIONS_H_
