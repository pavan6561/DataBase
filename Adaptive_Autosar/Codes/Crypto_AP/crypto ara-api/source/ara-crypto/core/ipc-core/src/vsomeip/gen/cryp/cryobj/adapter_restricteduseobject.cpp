...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_restricteduseobject.cpp
//
// Purpose     : Implementation of file adapter_restricteduseobject.cpp
// -----------------------------------------------------------------------------------------------------------
...
#include "adapter_restricteduseobject.h"
namespace ara
{
namespace crypto
{
...
RestrictedUseObjectServiceAdapter::~RestrictedUseObjectServiceAdapter() noexcept {
...
void RestrictedUseObjectServiceAdapter::DispatchMethodCall(const std::shared_ptr<::vsomeip::message>& msg)
{
...
void RestrictedUseObjectServiceAdapter::Connect(ServiceInterface& service) {
  service.AddDelegate(*this);
}

void RestrictedUseObjectServiceAdapter::Disconnect(ServiceInterface& service) {
  service.RemoveDelegate(*this);
}

void RestrictedUseObjectServiceAdapter::SendInitialNotification(ServiceInterface& service) {
}
