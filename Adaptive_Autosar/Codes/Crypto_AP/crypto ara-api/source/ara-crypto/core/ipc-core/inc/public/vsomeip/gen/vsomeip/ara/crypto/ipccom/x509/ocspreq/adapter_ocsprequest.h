...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_ocsprequest.h
//
// Purpose     : Implementation of file adapter_ocsprequest.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_OCSPREQ_ADAPTER_OCSPREQUEST_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_OCSPREQ_ADAPTER_OCSPREQUEST_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_ocsprequest.h"

#include "ara/crypto/ipccom/x509/ocspreq/ocsprequest_skeleton.h"
...
/// @brief Class for OcspRequestServiceAdapter.
class OcspRequestServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::OcspRequestSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on OcspRequestServiceAdapter.
  OcspRequestServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief OcspRequestServiceAdapter Destructor.
  virtual ~OcspRequestServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_OCSPREQ_ADAPTER_OCSPREQUEST_H_
