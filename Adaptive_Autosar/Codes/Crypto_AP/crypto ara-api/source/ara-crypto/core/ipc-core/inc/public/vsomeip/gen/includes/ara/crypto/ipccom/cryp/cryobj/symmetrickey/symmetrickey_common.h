...
// -----------------------------------------------------------------------------------------------------------
// File Name   : symmetrickey_common.h
//
// Purpose     : Implementation of file symmetrickey_common.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SYMMETRICKEY_SYMMETRICKEY_COMMON_H_
#define CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SYMMETRICKEY_SYMMETRICKEY_COMMON_H_
...
/// @brief Class for SymmetricKey.
class  SymmetricKey {
 public:
  /// @brief Definition for SymmetricKey.
  virtual ~SymmetricKey() noexcept
  {}
  static constexpr ara::com::internal::ServiceId service_id{0xB3B4};
...
#endif // CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SYMMETRICKEY_SYMMETRICKEY_COMMON_H_
