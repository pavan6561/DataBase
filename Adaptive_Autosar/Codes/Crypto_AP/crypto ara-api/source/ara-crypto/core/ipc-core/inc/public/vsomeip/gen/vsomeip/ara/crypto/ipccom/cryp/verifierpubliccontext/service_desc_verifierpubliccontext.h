...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_verifierpubliccontext.h
//
// Purpose     : Implementation of file service_desc_verifierpubliccontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_VERIFIERPUBLICCONTEXT_SERVICE_DESC_VERIFIERPUBLICCONTEXT_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_VERIFIERPUBLICCONTEXT_SERVICE_DESC_VERIFIERPUBLICCONTEXT_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x266F};
...
/// @brief class for GetSignatureService.
class GetSignatureService : public internal::Service {
 public:
...
/// @brief class for VerifyPrehashedHashFunction.
class VerifyPrehashedHashFunction : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x4};
  static constexpr bool is_reliable{false};
};
/// @brief class for VerifyPrehashedHashFunctionSignature.
class VerifyPrehashedHashFunctionSignature : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x1};
  static constexpr bool is_reliable{false};
};
/// @brief class for VerifyPrehashedReadOnly.
class VerifyPrehashedReadOnly : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x3};
  static constexpr bool is_reliable{false};
};
/// @brief class for VerifyReadOnly.
class VerifyReadOnly : public internal::Service {
 public:
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_VERIFIERPUBLICCONTEXT_SERVICE_DESC_VERIFIERPUBLICCONTEXT_H_
