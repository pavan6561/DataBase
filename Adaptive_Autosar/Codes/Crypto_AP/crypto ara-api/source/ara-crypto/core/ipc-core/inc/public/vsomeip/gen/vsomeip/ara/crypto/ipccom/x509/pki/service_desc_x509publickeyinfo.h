...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_x509publickeyinfo.h
//
// Purpose     : Implementation of file service_desc_x509publickeyinfo.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_PKI_SERVICE_DESC_X509PUBLICKEYINFO_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_PKI_SERVICE_DESC_X509PUBLICKEYINFO_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x26B9};
...
/// @brief class for GetAlgorithmId.
class GetAlgorithmId : public internal::Service {
 public:
...
/// @brief class for IsSameKey.
class IsSameKey : public internal::Service {
 public:
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_PKI_SERVICE_DESC_X509PUBLICKEYINFO_H_
