...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_digestservice.h
//
// Purpose     : Implementation of file service_desc_digestservice.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_DIGESTSERVICE_SERVICE_DESC_DIGESTSERVICE_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_DIGESTSERVICE_SERVICE_DESC_DIGESTSERVICE_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x268C};
...
/// @brief class for Compare.
class Compare : public internal::Service {
 public:
...
/// @brief class for GetDigestSize.
class GetDigestSize : public internal::Service {
 public:
...
/// @brief class for IsFinished.
class IsFinished : public internal::Service {
 public:
...
/// @brief class for IsStarted.
class IsStarted : public internal::Service {
 public:
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_DIGESTSERVICE_SERVICE_DESC_DIGESTSERVICE_H_
