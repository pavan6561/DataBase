...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_symmetrickeywrappercontext.h
//
// Purpose     : Implementation of file adapter_symmetrickeywrappercontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SYMMETRICKEYWRAPPER_ADAPTER_SYMMETRICKEYWRAPPERCONTEXT_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SYMMETRICKEYWRAPPER_ADAPTER_SYMMETRICKEYWRAPPERCONTEXT_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_symmetrickeywrappercontext.h"

#include "ara/crypto/ipccom/cryp/symmetrickeywrapper/symmetrickeywrappercontext_skeleton.h"
...
/// @brief Class for SymmetricKeyWrapperContextServiceAdapter.
class SymmetricKeyWrapperContextServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::SymmetricKeyWrapperContextSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on SymmetricKeyWrapperContextServiceAdapter.
  SymmetricKeyWrapperContextServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief SymmetricKeyWrapperContextServiceAdapter Destructor.
  virtual ~SymmetricKeyWrapperContextServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SYMMETRICKEYWRAPPER_ADAPTER_SYMMETRICKEYWRAPPERCONTEXT_H_
