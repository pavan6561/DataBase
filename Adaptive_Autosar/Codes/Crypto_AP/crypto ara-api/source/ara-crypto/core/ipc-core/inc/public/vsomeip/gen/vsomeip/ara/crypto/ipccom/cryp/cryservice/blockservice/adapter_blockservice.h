...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_blockservice.h
//
// Purpose     : Implementation of file adapter_blockservice.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_BLOCKSERVICE_ADAPTER_BLOCKSERVICE_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_BLOCKSERVICE_ADAPTER_BLOCKSERVICE_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_blockservice.h"

#include "ara/crypto/ipccom/cryp/cryservice/blockservice/blockservice_skeleton.h"
...
/// @brief Class for BlockServiceServiceAdapter.
class BlockServiceServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::BlockServiceSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on BlockServiceServiceAdapter.
  BlockServiceServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief BlockServiceServiceAdapter Destructor.
  virtual ~BlockServiceServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_BLOCKSERVICE_ADAPTER_BLOCKSERVICE_H_
