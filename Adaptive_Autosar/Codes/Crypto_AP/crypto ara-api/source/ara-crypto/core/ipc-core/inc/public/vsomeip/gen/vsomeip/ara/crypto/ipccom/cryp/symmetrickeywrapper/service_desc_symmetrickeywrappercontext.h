...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_symmetrickeywrappercontext.h
//
// Purpose     : Implementation of file service_desc_symmetrickeywrappercontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SYMMETRICKEYWRAPPER_SERVICE_DESC_SYMMETRICKEYWRAPPERCONTEXT_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SYMMETRICKEYWRAPPER_SERVICE_DESC_SYMMETRICKEYWRAPPERCONTEXT_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x2651};
...
/// @brief class for CalculateWrappedKeySize.
class CalculateWrappedKeySize : public internal::Service {
 public:
...
/// @brief class for GetMaxTargetKeyLength.
class GetMaxTargetKeyLength : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x6};
  static constexpr bool is_reliable{false};
};
/// @brief class for GetTargetKeyGranularity.
class GetTargetKeyGranularity : public internal::Service {
 public:
...
/// @brief class for UnwrapKey.
class UnwrapKey : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x2};
  static constexpr bool is_reliable{false};
};
/// @brief class for UnwrapSeed.
class UnwrapSeed : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x8};
  static constexpr bool is_reliable{false};
};
/// @brief class for WrapKeyMaterial.
class WrapKeyMaterial : public internal::Service {
 public:
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SYMMETRICKEYWRAPPER_SERVICE_DESC_SYMMETRICKEYWRAPPERCONTEXT_H_
