...
// -----------------------------------------------------------------------------------------------------------
// File Name   : decryptorprivatecontext_common.h
//
// Purpose     : Implementation of file decryptorprivatecontext_common.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_DECRYPTORPRIVATECONTEXT_DECRYPTORPRIVATECONTEXT_COMMON_H_
#define CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_DECRYPTORPRIVATECONTEXT_DECRYPTORPRIVATECONTEXT_COMMON_H_
...
/// @brief Class for DecryptorPrivateContext.
class  DecryptorPrivateContext {
 public:
  /// @brief Definition for DecryptorPrivateContext.
  virtual ~DecryptorPrivateContext() noexcept
  {}
  static constexpr ara::com::internal::ServiceId service_id{0xE835};
  ...
  {
    public:
    /// @brief Argument for cryptoInstanceId.
    CryptoServiceInstanceId cryptoInstanceId;
    /// @brief Using for success.
    using IsEnumerableTag = void;
    template<typename F>
    /// @brief Using for enumerate.
    void enumerate(F& fun) noexcept(false) {
      fun(cryptoInstanceId);
    }
  };
  ...
  static constexpr ara::core::Array<ara::core::ErrorCode, 3>ProcessBlockReadOnly_PossibleErrors {
    {
...
#endif // CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_DECRYPTORPRIVATECONTEXT_DECRYPTORPRIVATECONTEXT_COMMON_H_
