...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_x509publickeyinfo.h
//
// Purpose     : Implementation of file adapter_x509publickeyinfo.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_PKI_ADAPTER_X509PUBLICKEYINFO_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_PKI_ADAPTER_X509PUBLICKEYINFO_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_x509publickeyinfo.h"

#include "ara/crypto/ipccom/x509/pki/x509publickeyinfo_skeleton.h"
...
/// @brief Class for X509PublicKeyInfoServiceAdapter.
class X509PublicKeyInfoServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::X509PublicKeyInfoSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on X509PublicKeyInfoServiceAdapter.
  X509PublicKeyInfoServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief X509PublicKeyInfoServiceAdapter Destructor.
  virtual ~X509PublicKeyInfoServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_PKI_ADAPTER_X509PUBLICKEYINFO_H_
