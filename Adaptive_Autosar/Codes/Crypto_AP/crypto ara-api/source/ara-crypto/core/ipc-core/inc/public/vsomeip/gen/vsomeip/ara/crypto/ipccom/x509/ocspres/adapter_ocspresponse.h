...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_ocspresponse.h
//
// Purpose     : Implementation of file adapter_ocspresponse.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_OCSPRES_ADAPTER_OCSPRESPONSE_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_OCSPRES_ADAPTER_OCSPRESPONSE_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_ocspresponse.h"

#include "ara/crypto/ipccom/x509/ocspres/ocspresponse_skeleton.h"
...
/// @brief Class for OcspResponseServiceAdapter.
class OcspResponseServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::OcspResponseSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on OcspResponseServiceAdapter.
  OcspResponseServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief OcspResponseServiceAdapter Destructor.
  virtual ~OcspResponseServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_OCSPRES_ADAPTER_OCSPRESPONSE_H_
