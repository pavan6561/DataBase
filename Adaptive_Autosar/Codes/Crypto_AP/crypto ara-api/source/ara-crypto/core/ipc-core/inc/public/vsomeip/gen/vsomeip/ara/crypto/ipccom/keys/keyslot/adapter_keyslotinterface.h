...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_keyslotinterface.h
//
// Purpose     : Implementation of file adapter_keyslotinterface.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_KEYS_KEYSLOT_ADAPTER_KEYSLOTINTERFACE_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_KEYS_KEYSLOT_ADAPTER_KEYSLOTINTERFACE_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_keyslotinterface.h"

#include "ara/crypto/ipccom/keys/keyslot/keyslotinterface_skeleton.h"
...
/// @brief Class for KeySlotInterfaceServiceAdapter.
class KeySlotInterfaceServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::KeySlotInterfaceSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on KeySlotInterfaceServiceAdapter.
  KeySlotInterfaceServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief KeySlotInterfaceServiceAdapter Destructor.
  virtual ~KeySlotInterfaceServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_KEYS_KEYSLOT_ADAPTER_KEYSLOTINTERFACE_H_
