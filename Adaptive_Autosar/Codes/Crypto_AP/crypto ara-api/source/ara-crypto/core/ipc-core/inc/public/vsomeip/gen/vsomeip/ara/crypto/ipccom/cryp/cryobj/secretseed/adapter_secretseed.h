...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_secretseed.h
//
// Purpose     : Implementation of file adapter_secretseed.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SECRETSEED_ADAPTER_SECRETSEED_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SECRETSEED_ADAPTER_SECRETSEED_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_secretseed.h"

#include "ara/crypto/ipccom/cryp/cryobj/secretseed/secretseed_skeleton.h"
...
/// @brief Class for SecretSeedServiceAdapter.
class SecretSeedServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::SecretSeedSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on SecretSeedServiceAdapter.
  SecretSeedServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief SecretSeedServiceAdapter Destructor.
  virtual ~SecretSeedServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SECRETSEED_ADAPTER_SECRETSEED_H_
