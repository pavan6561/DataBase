...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_authciphercontext.h
//
// Purpose     : Implementation of file adapter_authciphercontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_AUTHENTICATIONCIPHER_ADAPTER_AUTHCIPHERCONTEXT_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_AUTHENTICATIONCIPHER_ADAPTER_AUTHCIPHERCONTEXT_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_authciphercontext.h"

#include "ara/crypto/ipccom/cryp/authenticationcipher/authciphercontext_skeleton.h"
...
/// @brief Class for AuthCipherContextServiceAdapter.
class AuthCipherContextServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::AuthCipherContextSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on AuthCipherContextServiceAdapter.
  AuthCipherContextServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief AuthCipherContextServiceAdapter Destructor.
  virtual ~AuthCipherContextServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_AUTHENTICATIONCIPHER_ADAPTER_AUTHCIPHERCONTEXT_H_
