...
// -----------------------------------------------------------------------------------------------------------
// File Name   : ocspresponse_common.h
//
// Purpose     : Implementation of file ocspresponse_common.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_X509_OCSPRES_OCSPRESPONSE_COMMON_H_
#define CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_X509_OCSPRES_OCSPRESPONSE_COMMON_H_
...
/// @brief Class for OcspResponse.
class  OcspResponse {
 public:
  /// @brief Definition for OcspResponse.
  virtual ~OcspResponse() noexcept
  {}
  static constexpr ara::com::internal::ServiceId service_id{0xC35D};
...
#endif // CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_X509_OCSPRES_OCSPRESPONSE_COMMON_H_
