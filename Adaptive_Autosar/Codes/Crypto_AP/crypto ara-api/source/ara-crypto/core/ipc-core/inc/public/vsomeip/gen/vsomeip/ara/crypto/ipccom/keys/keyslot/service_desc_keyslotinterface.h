...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_keyslotinterface.h
//
// Purpose     : Implementation of file service_desc_keyslotinterface.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_KEYS_KEYSLOT_SERVICE_DESC_KEYSLOTINTERFACE_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_KEYS_KEYSLOT_SERVICE_DESC_KEYSLOTINTERFACE_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x268B};
...
/// @brief class for Clear.
class Clear : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x3};
  static constexpr bool is_reliable{false};
};
/// @brief class for GetContentProps.
class GetContentProps : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x6};
  static constexpr bool is_reliable{false};
};
/// @brief class for GetPrototypedProps.
class GetPrototypedProps : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x5};
  static constexpr bool is_reliable{false};
};
/// @brief class for IsEmpty.
class IsEmpty : public internal::Service {
 public:
...
/// @brief class for Open.
class Open : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x7};
  static constexpr bool is_reliable{false};
};
/// @brief class for SaveCopy.
class SaveCopy : public internal::Service {
 public:
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_KEYS_KEYSLOT_SERVICE_DESC_KEYSLOTINTERFACE_H_
