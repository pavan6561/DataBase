...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_privatekey.cpp
//
// Purpose     : Implementation of file adapter_privatekey.cpp
// -----------------------------------------------------------------------------------------------------------
...
PrivateKeyServiceAdapter::~PrivateKeyServiceAdapter() noexcept {
...
void PrivateKeyServiceAdapter::DispatchMethodCall(const std::shared_ptr<::vsomeip::message>& msg)
{
...
void PrivateKeyServiceAdapter::Connect(ServiceInterface& service) {
  service.AddDelegate(*this);
}

void PrivateKeyServiceAdapter::Disconnect(ServiceInterface& service) {
  service.RemoveDelegate(*this);
}

void PrivateKeyServiceAdapter::SendInitialNotification(ServiceInterface& service) {
}
