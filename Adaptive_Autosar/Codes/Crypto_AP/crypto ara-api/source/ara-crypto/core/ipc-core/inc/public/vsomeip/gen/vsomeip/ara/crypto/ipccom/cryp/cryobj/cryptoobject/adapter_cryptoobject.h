...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_cryptoobject.h
//
// Purpose     : Implementation of file adapter_cryptoobject.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_CRYPTOOBJECT_ADAPTER_CRYPTOOBJECT_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_CRYPTOOBJECT_ADAPTER_CRYPTOOBJECT_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_cryptoobject.h"

#include "ara/crypto/ipccom/cryp/cryobj/cryptoobject/cryptoobject_skeleton.h"
...
/// @brief Class for CryptoObjectServiceAdapter.
class CryptoObjectServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::CryptoObjectSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on CryptoObjectServiceAdapter.
  CryptoObjectServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief CryptoObjectServiceAdapter Destructor.
  virtual ~CryptoObjectServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_CRYPTOOBJECT_ADAPTER_CRYPTOOBJECT_H_
