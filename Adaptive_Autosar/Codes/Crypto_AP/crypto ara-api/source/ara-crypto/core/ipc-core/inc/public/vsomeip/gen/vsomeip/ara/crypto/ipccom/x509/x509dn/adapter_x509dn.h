...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_x509dn.h
//
// Purpose     : Implementation of file adapter_x509dn.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_X509DN_ADAPTER_X509DN_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_X509DN_ADAPTER_X509DN_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_x509dn.h"

#include "ara/crypto/ipccom/x509/x509dn/x509dn_skeleton.h"
...
/// @brief Class for X509DNServiceAdapter.
class X509DNServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::X509DNSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on X509DNServiceAdapter.
  X509DNServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief X509DNServiceAdapter Destructor.
  virtual ~X509DNServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_X509_X509DN_ADAPTER_X509DN_H_
