...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_signature.h
//
// Purpose     : Implementation of file service_desc_signature.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SIGNATURE_SERVICE_DESC_SIGNATURE_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SIGNATURE_SERVICE_DESC_SIGNATURE_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x2656};
...
/// @brief class for GetHashAlgId.
class GetHashAlgId : public internal::Service {
 public:
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SIGNATURE_SERVICE_DESC_SIGNATURE_H_
