...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_publickey.h
//
// Purpose     : Implementation of file adapter_publickey.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_PUBILCKEY_ADAPTER_PUBLICKEY_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_PUBILCKEY_ADAPTER_PUBLICKEY_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_publickey.h"

#include "ara/crypto/ipccom/cryp/cryobj/pubilckey/publickey_skeleton.h"
...
/// @brief Class for PublicKeyServiceAdapter.
class PublicKeyServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::PublicKeySkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on PublicKeyServiceAdapter.
  PublicKeyServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief PublicKeyServiceAdapter Destructor.
  virtual ~PublicKeyServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_PUBILCKEY_ADAPTER_PUBLICKEY_H_
