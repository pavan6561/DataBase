...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_messageauthncode.h
//
// Purpose     : Implementation of file adapter_messageauthncode.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_MESSAGEAUTHENTICATIONCODE_ADAPTER_MESSAGEAUTHNCODE_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_MESSAGEAUTHENTICATIONCODE_ADAPTER_MESSAGEAUTHNCODE_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_messageauthncode.h"

#include "ara/crypto/ipccom/cryp/messageauthenticationcode/messageauthncode_skeleton.h"
...
/// @brief Class for MessageAuthnCodeServiceAdapter.
class MessageAuthnCodeServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::MessageAuthnCodeSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on MessageAuthnCodeServiceAdapter.
  MessageAuthnCodeServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief MessageAuthnCodeServiceAdapter Destructor.
  virtual ~MessageAuthnCodeServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_MESSAGEAUTHENTICATIONCODE_ADAPTER_MESSAGEAUTHNCODE_H_
