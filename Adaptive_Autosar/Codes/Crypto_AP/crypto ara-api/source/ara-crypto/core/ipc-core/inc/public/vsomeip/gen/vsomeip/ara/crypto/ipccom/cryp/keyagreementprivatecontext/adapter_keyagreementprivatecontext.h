...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_keyagreementprivatecontext.h
//
// Purpose     : Implementation of file adapter_keyagreementprivatecontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_KEYAGREEMENTPRIVATECONTEXT_ADAPTER_KEYAGREEMENTPRIVATECONTEXT_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_KEYAGREEMENTPRIVATECONTEXT_ADAPTER_KEYAGREEMENTPRIVATECONTEXT_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_keyagreementprivatecontext.h"

#include "ara/crypto/ipccom/cryp/keyagreementprivatecontext/keyagreementprivatecontext_skeleton.h"
...
/// @brief Class for KeyAgreementPrivateContextServiceAdapter.
class KeyAgreementPrivateContextServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::KeyAgreementPrivateContextSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on KeyAgreementPrivateContextServiceAdapter.
  KeyAgreementPrivateContextServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief KeyAgreementPrivateContextServiceAdapter Destructor.
  virtual ~KeyAgreementPrivateContextServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_KEYAGREEMENTPRIVATECONTEXT_ADAPTER_KEYAGREEMENTPRIVATECONTEXT_H_
