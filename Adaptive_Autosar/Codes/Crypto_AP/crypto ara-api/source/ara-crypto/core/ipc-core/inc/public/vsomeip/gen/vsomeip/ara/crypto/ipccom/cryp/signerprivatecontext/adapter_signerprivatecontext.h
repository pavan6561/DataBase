...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_signerprivatecontext.h
//
// Purpose     : Implementation of file adapter_signerprivatecontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SIGNERPRIVATECONTEXT_ADAPTER_SIGNERPRIVATECONTEXT_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SIGNERPRIVATECONTEXT_ADAPTER_SIGNERPRIVATECONTEXT_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_signerprivatecontext.h"

#include "ara/crypto/ipccom/cryp/signerprivatecontext/signerprivatecontext_skeleton.h"
...
/// @brief Class for SignerPrivateContextServiceAdapter.
class SignerPrivateContextServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::SignerPrivateContextSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on SignerPrivateContextServiceAdapter.
  SignerPrivateContextServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief SignerPrivateContextServiceAdapter Destructor.
  virtual ~SignerPrivateContextServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SIGNERPRIVATECONTEXT_ADAPTER_SIGNERPRIVATECONTEXT_H_
