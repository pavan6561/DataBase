...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_msgrecoverypubliccontext.h
//
// Purpose     : Implementation of file service_desc_msgrecoverypubliccontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_MSGRECOVERYPUBLICCONTEXT_SERVICE_DESC_MSGRECOVERYPUBLICCONTEXT_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_MSGRECOVERYPUBLICCONTEXT_SERVICE_DESC_MSGRECOVERYPUBLICCONTEXT_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x2668};
...
/// @brief class for DecodeAndVerify.
class DecodeAndVerify : public internal::Service {
 public:
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_MSGRECOVERYPUBLICCONTEXT_SERVICE_DESC_MSGRECOVERYPUBLICCONTEXT_H_
