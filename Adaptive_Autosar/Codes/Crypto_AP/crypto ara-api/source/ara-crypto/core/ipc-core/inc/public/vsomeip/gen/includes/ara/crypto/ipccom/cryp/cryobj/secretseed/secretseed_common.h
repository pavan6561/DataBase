...
// -----------------------------------------------------------------------------------------------------------
// File Name   : secretseed_common.h
//
// Purpose     : Implementation of file secretseed_common.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SECRETSEED_SECRETSEED_COMMON_H_
#define CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SECRETSEED_SECRETSEED_COMMON_H_
...
/// @brief Class for SecretSeed.
class  SecretSeed {
 public:
  /// @brief Definition for SecretSeed.
  virtual ~SecretSeed() noexcept
  {}
  static constexpr ara::com::internal::ServiceId service_id{0x5154};
  ...
  /// @brief class for CloneOutput.
  class CloneOutput
  {
    public:
    /// @brief Argument for SecretSeedUptr.
    CryptoServiceInstanceId SecretSeedUptr;
  ...
  static constexpr ara::core::Array<ara::core::ErrorCode, 2>JumpFrom_PossibleErrors {
    {
...
#endif // CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYOBJ_SECRETSEED_SECRETSEED_COMMON_H_
