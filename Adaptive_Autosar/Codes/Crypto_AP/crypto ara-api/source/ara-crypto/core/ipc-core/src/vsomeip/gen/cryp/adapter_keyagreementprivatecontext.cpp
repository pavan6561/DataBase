...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_keyagreementprivatecontext.cpp
//
// Purpose     : Implementation of file adapter_keyagreementprivatecontext.cpp
// -----------------------------------------------------------------------------------------------------------
...
#include "adapter_keyagreementprivatecontext.h"
namespace ara
{
namespace crypto
{
...
KeyAgreementPrivateContextServiceAdapter::~KeyAgreementPrivateContextServiceAdapter() noexcept {
...
void KeyAgreementPrivateContextServiceAdapter::DispatchMethodCall(const std::shared_ptr<::vsomeip::message>& msg)
{
  ServiceInterface& service{dynamic_cast<ServiceInterface&>(service_)};
  switch(msg->get_method()) {
    case descriptors::AgreeKey::method_id:
      HandleCall(service, &ServiceInterface::AgreeKey, msg);
    break;
    case descriptors::AgreeSeed::method_id:
      HandleCall(service, &ServiceInterface::AgreeSeed, msg);
    break;
...
void KeyAgreementPrivateContextServiceAdapter::Connect(ServiceInterface& service) {
  service.AddDelegate(*this);
}

void KeyAgreementPrivateContextServiceAdapter::Disconnect(ServiceInterface& service) {
  service.RemoveDelegate(*this);
}

void KeyAgreementPrivateContextServiceAdapter::SendInitialNotification(ServiceInterface& service) {
}
