...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_hashfunction.h
//
// Purpose     : Implementation of file adapter_hashfunction.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_HASHFUNCTION_ADAPTER_HASHFUNCTION_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_HASHFUNCTION_ADAPTER_HASHFUNCTION_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_hashfunction.h"

#include "ara/crypto/ipccom/cryp/hashfunction/hashfunction_skeleton.h"
...
/// @brief Class for HashFunctionServiceAdapter.
class HashFunctionServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::HashFunctionSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on HashFunctionServiceAdapter.
  HashFunctionServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief HashFunctionServiceAdapter Destructor.
  virtual ~HashFunctionServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_HASHFUNCTION_ADAPTER_HASHFUNCTION_H_
