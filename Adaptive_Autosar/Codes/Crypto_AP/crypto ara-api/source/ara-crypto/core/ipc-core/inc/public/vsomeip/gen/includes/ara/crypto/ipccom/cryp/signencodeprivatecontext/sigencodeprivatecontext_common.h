...
// -----------------------------------------------------------------------------------------------------------
// File Name   : sigencodeprivatecontext_common.h
//
// Purpose     : Implementation of file sigencodeprivatecontext_common.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_SIGNENCODEPRIVATECONTEXT_SIGENCODEPRIVATECONTEXT_COMMON_H_
#define CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_SIGNENCODEPRIVATECONTEXT_SIGENCODEPRIVATECONTEXT_COMMON_H_
...
/// @brief Class for SigEncodePrivateContext.
class  SigEncodePrivateContext {
 public:
  /// @brief Definition for SigEncodePrivateContext.
  virtual ~SigEncodePrivateContext() noexcept
  {}
  static constexpr ara::com::internal::ServiceId service_id{0x3312};
  ...
  static constexpr ara::core::Array<ara::core::ErrorCode, 2>SignAndEncode_PossibleErrors {
    {
  ...
  /// @brief class for SignAndEncodeOutput.
  class SignAndEncodeOutput
  {
    public:
...
#endif // CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_SIGNENCODEPRIVATECONTEXT_SIGENCODEPRIVATECONTEXT_COMMON_H_
