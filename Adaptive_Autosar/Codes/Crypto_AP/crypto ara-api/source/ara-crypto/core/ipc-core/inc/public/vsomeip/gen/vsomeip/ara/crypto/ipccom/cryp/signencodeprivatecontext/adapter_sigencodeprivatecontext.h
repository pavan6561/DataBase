...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_sigencodeprivatecontext.h
//
// Purpose     : Implementation of file adapter_sigencodeprivatecontext.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SIGNENCODEPRIVATECONTEXT_ADAPTER_SIGENCODEPRIVATECONTEXT_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SIGNENCODEPRIVATECONTEXT_ADAPTER_SIGENCODEPRIVATECONTEXT_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_sigencodeprivatecontext.h"

#include "ara/crypto/ipccom/cryp/signencodeprivatecontext/sigencodeprivatecontext_skeleton.h"
...
/// @brief Class for SigEncodePrivateContextServiceAdapter.
class SigEncodePrivateContextServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::SigEncodePrivateContextSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on SigEncodePrivateContextServiceAdapter.
  SigEncodePrivateContextServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief SigEncodePrivateContextServiceAdapter Destructor.
  virtual ~SigEncodePrivateContextServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_SIGNENCODEPRIVATECONTEXT_ADAPTER_SIGENCODEPRIVATECONTEXT_H_
