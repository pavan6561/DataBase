...
// -----------------------------------------------------------------------------------------------------------
// File Name   : blockservice_common.h
//
// Purpose     : Implementation of file blockservice_common.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_BLOCKSERVICE_BLOCKSERVICE_COMMON_H_
#define CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_BLOCKSERVICE_BLOCKSERVICE_COMMON_H_
...
/// @brief Class for BlockService.
class  BlockService {
 public:
  /// @brief Definition for BlockService.
  virtual ~BlockService() noexcept
  {}
  static constexpr ara::com::internal::ServiceId service_id{0xFF8A};
...
#endif // CRYPTOSERVEREXE_INCLUDES_ARA_CRYPTO_IPCCOM_CRYP_CRYSERVICE_BLOCKSERVICE_BLOCKSERVICE_COMMON_H_
