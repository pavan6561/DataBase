...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_cryptoproviderinterface.h
//
// Purpose     : Implementation of file adapter_cryptoproviderinterface.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYPTOPROVIDER_ADAPTER_CRYPTOPROVIDERINTERFACE_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYPTOPROVIDER_ADAPTER_CRYPTOPROVIDERINTERFACE_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_cryptoproviderinterface.h"

#include "ara/crypto/ipccom/cryp/cryptoprovider/cryptoproviderinterface_skeleton.h"
...
/// @brief Class for CryptoProviderInterfaceServiceAdapter.
class CryptoProviderInterfaceServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::CryptoProviderInterfaceSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on CryptoProviderInterfaceServiceAdapter.
  CryptoProviderInterfaceServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief CryptoProviderInterfaceServiceAdapter Destructor.
  virtual ~CryptoProviderInterfaceServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_CRYPTOPROVIDER_ADAPTER_CRYPTOPROVIDERINTERFACE_H_
