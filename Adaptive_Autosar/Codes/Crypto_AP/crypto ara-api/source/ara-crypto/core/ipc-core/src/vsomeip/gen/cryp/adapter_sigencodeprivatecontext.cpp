...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_sigencodeprivatecontext.cpp
//
// Purpose     : Implementation of file adapter_sigencodeprivatecontext.cpp
// -----------------------------------------------------------------------------------------------------------
...
#include "adapter_sigencodeprivatecontext.h"
namespace ara
{
namespace crypto
{
...
SigEncodePrivateContextServiceAdapter::~SigEncodePrivateContextServiceAdapter() noexcept {
...
void SigEncodePrivateContextServiceAdapter::DispatchMethodCall(const std::shared_ptr<::vsomeip::message>& msg)
{
  ...
  switch(msg->get_method()) {
    ...
    break;
    case descriptors::SignAndEncode::method_id:
      HandleCall(service, &ServiceInterface::SignAndEncode, msg);
    break;
    default:
    // Avoid Warning.
    break;
...
void SigEncodePrivateContextServiceAdapter::Connect(ServiceInterface& service) {
  service.AddDelegate(*this);
}

void SigEncodePrivateContextServiceAdapter::Disconnect(ServiceInterface& service) {
  service.RemoveDelegate(*this);
}

void SigEncodePrivateContextServiceAdapter::SendInitialNotification(ServiceInterface& service) {
}
