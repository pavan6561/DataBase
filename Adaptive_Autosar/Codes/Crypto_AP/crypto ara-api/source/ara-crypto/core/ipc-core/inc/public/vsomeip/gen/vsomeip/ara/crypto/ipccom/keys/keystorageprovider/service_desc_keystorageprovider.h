...
// -----------------------------------------------------------------------------------------------------------
// File Name   : service_desc_keystorageprovider.h
//
// Purpose     : Implementation of file service_desc_keystorageprovider.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_KEYS_KEYSTORAGEPROVIDER_SERVICE_DESC_KEYSTORAGEPROVIDER_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_KEYS_KEYSTORAGEPROVIDER_SERVICE_DESC_KEYSTORAGEPROVIDER_H_
...
class Service {
 public:
  ...
  static constexpr ara::com::internal::vsomeip::types::ServiceId service_id{0x268A};
...
/// @brief class for BeginTransaction.
class BeginTransaction : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x2};
  static constexpr bool is_reliable{false};
};
/// @brief class for GetRegisteredObserver.
class GetRegisteredObserver : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x6};
  static constexpr bool is_reliable{false};
};
/// @brief class for LoadKeySlot.
class LoadKeySlot : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x1};
  static constexpr bool is_reliable{false};
};
/// @brief class for RegisterObserver.
class RegisterObserver : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x5};
  static constexpr bool is_reliable{false};
};
/// @brief class for RollbackTransaction.
class RollbackTransaction : public internal::Service {
 public:
  static constexpr ara::com::internal::vsomeip::types::MethodId method_id{0x3};
  static constexpr bool is_reliable{false};
};
/// @brief class for UnsubscribeObserver.
class UnsubscribeObserver : public internal::Service {
 public:
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_KEYS_KEYSTORAGEPROVIDER_SERVICE_DESC_KEYSTORAGEPROVIDER_H_
