...
// -----------------------------------------------------------------------------------------------------------
// File Name   : adapter_keyderivationfunction.h
//
// Purpose     : Implementation of file adapter_keyderivationfunction.h
// -----------------------------------------------------------------------------------------------------------
...
#ifndef CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_KEYDERIVATIONFUNCTION_ADAPTER_KEYDERIVATIONFUNCTION_H_
#define CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_KEYDERIVATIONFUNCTION_ADAPTER_KEYDERIVATIONFUNCTION_H_

#include <ara/com/internal/vsomeip/skeleton/vsomeip_skeleton_base.h>
#include "service_desc_keyderivationfunction.h"

#include "ara/crypto/ipccom/cryp/keyderivationfunction/keyderivationfunction_skeleton.h"
...
/// @brief Class for KeyDerivationFunctionServiceAdapter.
class KeyDerivationFunctionServiceAdapter : public
  ::ara::com::internal::vsomeip::skeleton::ServiceImplBase {
 public:
  /// @brief Using for ServiceInterface.
  using ServiceInterface = skeleton::KeyDerivationFunctionSkeleton;
  /// @brief Using for ServiceDescriptor.
  using ServiceDescriptor = descriptors::internal::Service;

  /// @brief description on KeyDerivationFunctionServiceAdapter.
  KeyDerivationFunctionServiceAdapter(ServiceInterface& service, ara::com::internal::vsomeip::types::InstanceId instance) :
  ...
  /// @brief KeyDerivationFunctionServiceAdapter Destructor.
  virtual ~KeyDerivationFunctionServiceAdapter() noexcept override;
...
#endif // CRYPTOSERVEREXE_VSOMEIP_ARA_CRYPTO_IPCCOM_CRYP_KEYDERIVATIONFUNCTION_ADAPTER_KEYDERIVATIONFUNCTION_H_
