...
template <>
inline bool convert::fromString<iox::cxx::string<100>>(const char* v, iox::cxx::string<100>& dest) noexcept
{
    dest = iox::cxx::string<100>(iox::cxx::TruncateToCapacity, v);
    return true;
}
...
inline bool convert::fromString<float>(const char* v, float& dest) noexcept
{
    ...
    return !iox::posix::posixCall(strtof)(v, nullptr)
...
inline bool convert::fromString<double>(const char* v, double& dest) noexcept
{
    ...
    return !iox::posix::posixCall(strtod)(v, nullptr)
...
inline bool convert::fromString<long double>(const char* v, long double& dest) noexcept
{
    ...
    return !iox::posix::posixCall(strtold)(v, nullptr)
...
inline bool convert::fromString<uint64_t>(const char* v, uint64_t& dest) noexcept
{
    ...
    auto call = iox::posix::posixCall(strtoull)(v, nullptr, STRTOULL_BASE).failureReturnValue(ULLONG_MAX).evaluate();
...
inline bool convert::fromString<uint16_t>(const char* v, uint16_t& dest) noexcept
{
    ...
    auto call = iox::posix::posixCall(strtoul)(v, nullptr, STRTOULL_BASE).failureReturnValue(ULONG_MAX).evaluate();
...
inline bool convert::fromString<int64_t>(const char* v, int64_t& dest) noexcept
{
    ...
    auto call =
        iox::posix::posixCall(strtoll)(v, nullptr, STRTOULL_BASE).failureReturnValue(LLONG_MAX, LLONG_MIN).evaluate();
    if (call.has_error())
    {
        return false;
    }
...
inline bool convert::fromString<int16_t>(const char* v, int16_t& dest) noexcept
{
    ...
    auto call = iox::posix::posixCall(strtol)(v, nullptr, STRTOULL_BASE).failureReturnValue(LONG_MAX, LONG_MIN).evaluate();
    if (call.has_error())
    {
        return false;
    }
...
inline bool convert::fromString<bool>(const char* v, bool& dest) noexcept
{
    ...
    return !iox::posix::posixCall(strtoul)(v, nullptr, STRTOULL_BASE)
