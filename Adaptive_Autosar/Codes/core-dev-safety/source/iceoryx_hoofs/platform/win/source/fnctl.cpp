...
{
  auto handle = Win32Call(CreateFileA, pathname, GENERIC_WRITE, 0, static_cast<LPSECURITY_ATTRIBUTES>(NULL),
      CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, static_cast<HANDLE>(NULL))
                    .value;
