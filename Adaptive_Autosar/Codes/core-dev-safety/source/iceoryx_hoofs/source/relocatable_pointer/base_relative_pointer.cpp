...
namespace rp
{
BaseRelativePointer::BaseRelativePointer(ptr_t ptr, id_t id) noexcept : m_id(id), m_offset(computeOffset(ptr))
{
}

BaseRelativePointer::BaseRelativePointer(offset_t offset, id_t id) noexcept : m_id(id), m_offset(offset)
{
}

BaseRelativePointer::BaseRelativePointer(ptr_t ptr) noexcept :
    m_id(searchId(ptr)), m_offset(computeOffset(ptr))
{
}
...
BaseRelativePointer::BaseRelativePointer(const BaseRelativePointer& other) noexcept :
    m_id(other.m_id), m_offset(other.m_offset)
{
}
...
PointerRepository<BaseRelativePointer::id_t, BaseRelativePointer::ptr_t>&
