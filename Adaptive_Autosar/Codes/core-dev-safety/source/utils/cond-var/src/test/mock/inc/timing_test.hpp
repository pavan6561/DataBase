...
#ifndef CORE_SOURCE_UTILS_COND_VAR_SRC_TEST_MOCK_INC_TIMING_TEST_H
#define CORE_SOURCE_UTILS_COND_VAR_SRC_TEST_MOCK_INC_TIMING_TEST_H
...
#endif // CORE_SOURCE_UTILS_COND_VAR_SRC_TEST_MOCK_INC_TIMING_TEST_H
