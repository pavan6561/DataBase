...
#ifndef CORE_SOURCE_UTILS_COND_VAR_SRC_TEST_MOCK_INC_BARRIER_H
#define CORE_SOURCE_UTILS_COND_VAR_SRC_TEST_MOCK_INC_BARRIER_H
...
#endif // CORE_SOURCE_UTILS_COND_VAR_SRC_TEST_MOCK_INC_BARRIER_H
