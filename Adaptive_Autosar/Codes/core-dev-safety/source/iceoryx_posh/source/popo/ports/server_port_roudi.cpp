  ...
  if (isOffered)
  {
    if (!offeringRequested)
    {
      capro::CaproMessage caproMessage(
          capro::CaproMessageType::STOP_OFFER, this->getCaProServiceDescription());
...
cxx::optional<capro::CaproMessage> ServerPortRouDi::dispatchCaProMessageAndGetPossibleResponse(
...
cxx::optional<capro::CaproMessage> ServerPortRouDi::handleCaProMessageForStateOffered(
    const capro::CaproMessage& caProMessage) noexcept
{
...
cxx::optional<capro::CaproMessage> ServerPortRouDi::handleCaProMessageForStateNotOffered(
    const capro::CaproMessage& caProMessage) noexcept
{
  switch (caProMessage.m_type)
  {
