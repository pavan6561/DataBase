...
cxx::optional<capro::CaproMessage> ClientPortRouDi::tryGetCaProMessage() noexcept
{
  ...
  case ConnectionState::NOT_CONNECTED:
    if (currentConnectRequest)
    {
      capro::CaproMessage caproMessage(
          capro::CaproMessageType::CONNECT, BasePort::getMembers()->m_serviceDescription);
  ...
  case ConnectionState::CONNECTED:
    ...
    {
      capro::CaproMessage caproMessage(
          capro::CaproMessageType::DISCONNECT, BasePort::getMembers()->m_serviceDescription);
      return dispatchCaProMessageAndGetPossibleResponse(caproMessage);
    }
    break;
  default:
...
cxx::optional<capro::CaproMessage> ClientPortRouDi::dispatchCaProMessageAndGetPossibleResponse(
...
cxx::optional<capro::CaproMessage> ClientPortRouDi::handleCaProMessageForStateNotConnected(
    const capro::CaproMessage& caProMessage) noexcept
{
...
cxx::optional<capro::CaproMessage> ClientPortRouDi::handleCaProMessageForStateConnectRequested(
    const capro::CaproMessage& caProMessage) noexcept
{
  switch (caProMessage.m_type)
  {
...
cxx::optional<capro::CaproMessage> ClientPortRouDi::handleCaProMessageForStateWaitForOffer(
    const capro::CaproMessage& caProMessage) noexcept
{
  switch (caProMessage.m_type)
  {
...
cxx::optional<capro::CaproMessage> ClientPortRouDi::handleCaProMessageForStateConnected(
    const capro::CaproMessage& caProMessage) noexcept
{
  switch (caProMessage.m_type)
  {
...
cxx::optional<capro::CaproMessage> ClientPortRouDi::handleCaProMessageForStateDisconnectRequested(
    const capro::CaproMessage& caProMessage) noexcept
{
  switch (caProMessage.m_type)
  {
