...
PublisherPortRouDi::PublisherPortRouDi(cxx::not_null<MemberType_t* const> publisherPortDataPtr) noexcept :
    BasePort(publisherPortDataPtr), m_chunkSender(&getMembers()->m_chunkSenderData)
{
}
...
cxx::optional<capro::CaproMessage> PublisherPortRouDi::dispatchCaProMessageAndGetPossibleResponse(
